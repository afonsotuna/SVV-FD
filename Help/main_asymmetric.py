...
def num_model_asym_reference(output=1, t_lookup=3717, t_limit=14, eigenmotion = "dutch roll", block_fuel=4050, passenger_weight=695, b=15.911,
                             CY_b=-0.7500, Cn_r=-0.2061, Cn_p=-0.0602, Cl_r=0.2376, Cl_p=-0.7108,data = "actual"):
    ...
    if data == "reference":
        ...
        if eigenmotion == "spiral":
            input_delta_a = flight_data[index:index + n_points, 15] * m.pi / 180 - flight_data[index+n_points, 15] * m.pi/180
            input_delta_r = -(flight_data[index:index + n_points, 17] * m.pi / 180 - flight_data[index+n_points, 17] * m.pi/180)
    if data == "actual":
        if eigenmotion == "dutch roll":
            input_delta_a = flight_data[index:index + n_points, 15] * m.pi / 180 - flight_data[index + n_points, 15] * m.pi / 180
            input_delta_r = -flight_data[index:index + n_points, 17] * m.pi / 180
    ...
    t2, out, p2 = control.forced_response(sys, T=t1, U=input_tot,X0=[0., flight_data[index, 20]* m.pi / 180,  flight_data[index, 25]* m.pi / 180, flight_data[index, 27]* m.pi / 180])
...
def make_plot_asym(output=1, eigenmotion = "dutch roll", t_lookup=3717, t_limit=14, block_fuel=4050, passenger_weight=695, b=15.911, CY_b=-0.7500,
                   Cn_r=-0.2061, Cn_p=-0.0602, Cl_r=0.2376, Cl_p=-0.7108,data = "actual"):
...
data = "actual"
make_plot_asym(output=1, eigenmotion = "spiral", t_lookup=3590, t_limit=120, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=2, eigenmotion = "spiral", t_lookup=3590, t_limit=120, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=3, eigenmotion = "spiral", t_lookup=3590, t_limit=120, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=1, eigenmotion = "dutch roll", t_lookup=3455, t_limit=15, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=2, eigenmotion = "dutch roll", t_lookup=3455, t_limit=15, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=3, eigenmotion = "dutch roll", t_lookup=3455, t_limit=15, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=1, eigenmotion = "aperiodic", t_lookup=3050, t_limit=20, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=2, eigenmotion = "aperiodic", t_lookup=3050, t_limit=20, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)
make_plot_asym(output=3, eigenmotion = "aperiodic", t_lookup=3050, t_limit=20, CY_b = -2.560698700667486, Cn_r = 0.0, Cn_p = 0.0, Cl_r = 0.09170271668625395, Cl_p = -0.7930823749878441,data = data)